...
@section('title', __('keywords.create_coupon'))
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{ old('discount_percentage') }}"
                                                            class="form-control"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="{{ old('limit') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" value="{{ old('time_used') }}"
                                                            class="form-control"
