...
@section('title', __('keywords.create_brand'))
        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-9 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">{{ __('keywords.brands_table') }}</h3>
                                    ...
                                    <form class="form" action="{{ route('admin.brands.store')}}" method="POST" enctype="multipart/form-data" >
                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" value="{{ old('logo')}}" class="form-control" id="single-image"
                                                    placeholder="{{ __('keywords.logo') }}" name="logo">
                                                    <x-error-validate field="logo" />
                                            </div>
