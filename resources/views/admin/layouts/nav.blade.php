                                  ...
                                  <div id="mega-menu-carousel-example">
                                      <div>
                                          <img class="rounded img-fluid mb-1"
                                              src="{{ asset('admin-assets') }}/images/slider/slider-2.png"
                  ...
                  <ul class="nav navbar-nav float-right">
                      ...
                      <li class="dropdown dropdown-language nav-item">
                          <a class="dropdown-toggle nav-link" id="dropdown-flag" href="#"
                              ...
                              <i
                                  class="flag-icon  @if (LaravelLocalization::getCurrentLocale() == 'en') flag-icon-gb
         @else flag-icon-eg @endif"></i><span
                              ...
                              <li class="scrollable-container media-list w-100">
                                  ...
                                  <a href="javascript:void(0)">
                                      <div class="media">
                                          <div class="media-left">
                                              <span class="avatar avatar-sm avatar-online rounded-circle">
                                                  <img src="{{ asset('admin-assets') }}/images/portrait/small/avatar-s-3.png"
                                                      alt="avatar"><i></i></span>
                                          </div>
                                          <div class="media-body">
