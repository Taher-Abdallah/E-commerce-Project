...
@section('title', __('keywords.create_product'))
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('keywords.create_product') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content-body">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('keywords.create_product') }}</h4>
                            </div>
                                        ...
                                        <form action="{{ route('admin.products.store') }}" method="POST"
                                            ...
                                            <div id="step1">
                                                ...
                                                <div class="row mt-2">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="manage_stock" id="manage_stock"
                                                                ...
                                                                <option value="1"
                                                                    {{ old('manage_stock') == '1' ? 'selected' : '' }}>Yes
                                                                </option>
                                                                <option value="0"
                                                                    {{ old('manage_stock') == '0' ? 'selected' : '' }}>No
                                                                </option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 quantity-field"
                                                        style="display: {{ old('manage_stock') == '1' ? 'block' : 'none' }};">
                                                        <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="available_in_stock" class="form-control">
                                                                <option value="1"
                                                                    {{ old('available_in_stock', '1') == '1' ? 'selected' : '' }}>
                                                                    Available</option>
                                                                <option value="0"
                                                                    {{ old('available_in_stock') == '0' ? 'selected' : '' }}>
                                            ...
                                            <div id="step2"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" name="images[]" id="multiple-image" multiple
                                                        class="form-control">
                                                ...
                                                <div class="row mt-3">
                                                    <div class="col-md-6">
                                                        ...
                                                        <select name="has_variants" id="has_variants"
                                                            ...
                                                            <option value="">-- Select --</option>
                                                            <option value="1"
                                                                {{ old('has_variants') == '1' ? 'selected' : '' }}>Yes
                                                            </option>
                                                            <option value="0"
                                                                {{ old('has_variants') == '0' ? 'selected' : '' }}>No
                                                            </option>
                                                        </select>
                                                    ...
                                                    <div class="col-md-6 price-field"
                                                        style="display: {{ old('has_variants') == '1' ? 'none' : 'block' }};">
                                                        <label>Price</label>
                                                ...
                                                <h5 id="variantsHeader"
                                                    style="display: {{ old('has_variants') == '1' ? 'block' : 'none' }};">
                                                    Product Variants</h5>
                                                <button type="button" id="addVariantBtn"
                                                    class="btn btn-success btn-sm mb-2"
                                                    style="display: {{ old('has_variants') == '1' ? 'inline-block' : 'none' }};">+
                                                    Add Variant</button>
...
@push('js')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let variantIndex = 0; // ⬅️ عداد للـ variants
        ...
        `;
            ...
            // =============================================
            // 5️⃣ تحميل Old Variants (مرة واحدة فقط!)
            // =============================================
            ...
            if (Object.keys(oldVariants).length > 0) {
                Object.keys(oldVariants).forEach(function(key) {
                    ...
                    variantsContainer.append(createVariantHtml(key, variant));
