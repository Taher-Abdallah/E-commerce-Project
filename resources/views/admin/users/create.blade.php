...
@section('title', __('keywords.create_user'))
                    ...
                    <div class="row breadcrumbs-top d-inline-block">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('keywords.create_user') }}</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="content-body">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('keywords.create_user') }}</h4>
                            </div>
                                        ...
                                        <form action="{{ route('admin.users.store') }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary">
                                                    <i class="la la-check"></i> {{ __('keywords.save') }}
                                                </button>
...
@push('js')
    <!-- في نهاية الصفحة أو في section scripts -->
    <script>
