                ...
                <div class="row ">
                                ...
                                <div class="swiper-wrapper">
                                    @foreach ($product->productImages as $item)
                                        <div class="swiper-slide slider-top-img">
                                            <img src="{{ asset('storage/products/' . $item->file_name) }}" alt="img">
                                        </div>
                                    @endforeach
                    ...
                    <div class="col-md-6">
                        <div class="product-info-content">
                            {{-- product details the right side page  --}}
                                    ...
                                    <div class="login-section account-section modal-main">
                                        <div class="review-form">
                                            <div class="review-content">
                                                ...
                                                <div class="close-btn">
                                                    <img src="{{ asset('user-assets/assets/images/homepage-one/close-btn.png') }}"
                    ...
                    <div class="tab-pane fade" id="nav-review" role="tabpanel" aria-labelledby="nav-review-tab"
                        ...
                        <div class="product-review-section" >
                            ...
                            <div class="review-wrapper">
                                <div class="wrapper">
                                    @forelse ($product->productPreviews as $review)
                                        <div class="wrapper-aurthor">
                                            <div class="wrapper-info">
                                                <div class="aurthor-img">
                                                    <img src="{{ asset('user-assets/assets/images/homepage-one/aurthor-img-1.webp') }}"
                                                        alt="aurthor-img">
                                                </div>
                                                <div class="author-details">
                                                    <h5>{{ $review->user->name }}</h5>
                                                    <p>{{ $review->user->country->name }}, {{ $review->user->city->name }}
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="ratings">
    ...
    <section class="product weekly-sale product-weekly footer-padding">
        <div class="container">
            <div class="section-title">
                ...
                <a href="{{ route('user.products.related.items', $product->slug) }}" class="view">View All</a>
            </div>
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="product-wrapper" >
                                <div class="product-img">
                                    <img src="{{ asset('storage/products/' . $item->productImages->first()->file_name) }}"
                                        alt="product-img">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-description">
                                        <a href="{{ route('user.products.show', $item->slug) }}"
