...
@section('content')
    @if ($products->count() > 0)
        ...
        <section class="product product-sidebar @if($flashTimer) flash-sale  @endif footer-padding">
            <div class="container">
                <div class="row g-5">
                    <div class="col-lg-12">
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-lg-12">
                                    <div class="product-sorting-section">
                                        <div class="result">
                                            <p>{{ __('keywords.showing') }}
                                                <span>{{ $products->firstItem() }}–{{ $products->lastItem() }}
                                                    of {{ $products->total() }}
                                                    {{ __('keywords.results') }}</span></p>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="product-wrapper" data-aos="fade-up">
                                            <div class="product-img">
                                                ...
                                                <div class="product-cart-items">
                                                    {{-- to show product in big page --}}
                                                    <a href="{{ route('user.category.show',$item->slug) }}" class="cart cart-item">
                                                        <span>
        ...
        <section class="blog about-blog footer-padding">
            <div class="container">
                <div class="blog-item" data-aos="fade-up">
                    <div class="cart-img">
                        <img src="{{ asset('assets/keywords/assets/images/homepage-one/empty-wishlist.webp') }}" alt>
                    </div>
                    <div class="cart-content">
                        <p class="content-title">{{ __('keywords.no_products') }}</p>
                        <a href="product-sidebar.html" class="shop-btn">{{ __('keywords.back_to_shop') }}</a>
                    </div>
                </div>
            </div>
        </section>
