    ...
    <section class="faq product footer-padding">
      <div class="container">
        <div class="row gy-5">
          <div class="col-lg-6">
            <div
              class="faq-accordion accordion accordion-flush"
            ...
            >
              ...
              <div class="faq-item accordion-item">
                <h2 class="accordion-header">
                  <button
                    class="faq-button accordion-button collapsed"
                    type="button"
...
@push('js')
<script>
    window.addEventListener('faq-question-created', e => {
        Swal.fire({
            position: 'top-center',
            icon: 'success',
            title: e.detail,
