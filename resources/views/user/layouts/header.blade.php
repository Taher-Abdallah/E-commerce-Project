        ...
        <div class="header-center-section d-none d-lg-block">
            <div class="container">
                <div class="header-center">
                    <div class="logo">
                        <a href="index-2.html">
                            <img src="{{ asset('user-assets') }}/assets/images/logos/logo.webp" alt="logo">
                        </a>
                    </div>
                    <div class="header-cart-items">
                        ...
                        @livewire('user.wishlist.wishlist-like')
                            ...
                            <li class="mega-menu">
                                ...
                                <div class="shop-menu">
                                    ...
                                    <div class="shop-menu-img">
                                        <img src="{{ asset('user-assets') }}/assets/images/homepage-one/empty-wishlist.webp"
                                            alt="img">
                                    </div>
                                </div>
                            </li>
